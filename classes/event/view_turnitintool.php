...
class view_turnitintool extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('view_turnitintool', 'mod_turnitintool');
    }
    ...
    public function get_legacy_logdata() {
        ...
        return array($this->courseid, "turnitintool", "view turnitintool", 'view.php?id='.$this->objectid, $this->other['desc'], $this->objectid);
    }
